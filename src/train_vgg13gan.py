...
# Training settings
parser = argparse.ArgumentParser(description='VGG13+GAN Training Code')
parser.add_argument('--batch-size', type=int, default=128, help='Training batch size')
parser.add_argument('--epochs', type=int, default=60, help='Training epochs')
parser.add_argument('--lr', type=float, default=0.0002, help='Learning Rate')
parser.add_argument('--no-cuda', action='store_true', default=False, help='disables CUDA training')
parser.add_argument('--seed', type=int, default=1, help='random seed')
parser.add_argument('--log-interval', type=int, default=100, help='Log progress after x batch iterations')
parser.add_argument('--dataset', required=True, default='Din1', help='In-distribution dataset "Din1" or "Din2"')
parser.add_argument('--dataroot', required=True, help='Path to the training dataset')
parser.add_argument('--imageSize', type=int, default=32, help='the height / width of the input image to train')
parser.add_argument('--outf', default='./outf/ganmodel', help='folder to save the training weights')
parser.add_argument('--wd', type=float, default=0.0, help='weight decay')
parser.add_argument('--droprate', type=float, default=0.0, help='Rearning Rate decay')
